            ...
            <div className="AboutPage color-5-background">
                <div className="MainBox AboutBox">
                    ...
                    &emsp;&emsp;At HealthTrace it is our goal to make the healthcare industry's data more accessible and useable for every person. 
                        ...
                        we can find faults in our current system that might lead to learning more about drug targeting and pharmaceutical marketing strategies. The data collected and used on this platform was collected from government datasets and was not altered in any.
